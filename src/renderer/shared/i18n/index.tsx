...
const zh: Record<string, string> = {
  ...
  "Downloading update": "正在下载更新",
  "Downloading installer": "正在下载安装包",
  "Restart to update": "重启更新",
  "Retry update": "重试更新",
  "Retry update download": "重试下载更新",
  "Open installer": "打开安装包",
  "Opening…": "正在打开…",
  "Update installer opened": "更新安装包已打开",
  "Drag Buzz into the Applications folder to replace the old version, then reopen Buzz from Applications.": "请将 Buzz 拖入「应用程序」文件夹替换旧版本，然后从「应用程序」重新打开 Buzz 完成更新。",
  "Reopen installer": "重新打开安装包",
  "Done": "完成",
