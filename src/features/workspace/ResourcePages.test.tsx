...
import { setSavedCredential } from "../ssh/savedCredentials";
import { createDeterministicForwardingApi } from "../forwarding/deterministicForwardingApi";
import { createForwardingState } from "../forwarding/forwardingStore";
import { PortForwardingPage } from "./ResourcePages";
...
describe("port forwarding page", () => {
  ...
  it("creates a rule via the store and starts/stops the transport", async () => {
    ...
    const store = create<import("../forwarding/forwardingStore").ForwardingState>()(
